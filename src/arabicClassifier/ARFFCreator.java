...
public class ARFFCreator {
	...
	public static void main(String[] args) throws ClassNotFoundException, IOException {
		...
		String arffDirectory = "E:/projects/Utilities";//where you want to save the ARFF File
		String datasetDirectory = "E:/projects/Utilities/dataset";//where your dataset is (should contain sub-directories for each class (label or attribute).
		...
		createArffHeader(arffDirectory+"/myArff.arff", Arrays.toString(classes),Arrays.toString(classes));//method to create the ARFF file, the third argument is the datatype you may need to change this manually at some point (e.g. "String, String, Int, Int")
	...
	public static void createArffHeader(String arffFile, String classes, String classesTypes)
		...
		writer.println("@relation arabicText");
		writer.print("\n");
		writer.println("@attribute arabicclass {"+classes.replace("[", "").replace("]", "").trim()+"}");
